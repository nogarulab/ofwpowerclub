                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control dob-inputs" name="dob_month" style="width: 90px">
                                                ...
                                                <select class="form-control dob-inputs" name="dob_day" style="width: 90px">
                                                ...
                                                <select class="form-control dob-inputs" name="dob_year" style="width: 90px">
                                            ...
                                            <div class="form-group">
                                                <label for="">Hong Kong I.D.# / Passport Number</label>
                                                <input type="text" name="passport_number" class="input-sm form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <hr/>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="beneficiary_name" class="input-sm form-control"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Address of Beneficiary</label>
                                                <input type="text" name="beneficiary_address" class="input-sm form-control"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Contact Number</label>
                                                <input type="text" name="beneficiary_contact" class="input-sm form-control"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Relationship with Beneficiary</label>
                                                <input type="text" name="beneficiary_relationship" class="input-sm form-control"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
